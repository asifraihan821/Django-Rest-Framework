...
def initiate_payment(request):
    ...
    num_of_items = request.data.get("num_of_items")
    settings = { 'store_id': 'phima68cf7c5d91d47', 'store_pass': 'phima68cf7c5d91d47@ssl', 'issandbox': True }
    ...
    return Response({"error": "Payment inititaio failed."}, status=status.HTTP_400_BAD_REQUEST)
